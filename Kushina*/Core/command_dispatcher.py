...
class CommandDispatcher(MixinBase):
    ...
    def unregister_command(self: "kushina", cmd: command.Command) -> None:
    ...
    def register_commands(self: "kushina", plug: plugin.Plugin) -> None:
    ...
    def unregister_commands(self: "kushina", plug: plugin.Plugin) -> None:
    ...
    def command_predicate(self: "kushina") -> Filter:
        async def func(_: Filter, client: Client, message: Message) -> bool:
            ...
            if message.text is not None and message.text.startswith("/"):
                ...
                # eg: /ping@dkushina_bot will return True
