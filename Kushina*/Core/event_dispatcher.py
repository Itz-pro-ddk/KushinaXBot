...
from kushina import plugin, util
from kushina.error import EventDispatchError
from kushina.listener import Listener, ListenerFunc
from kushina.util.misc import StopPropagation
...
class EventDispatcher(MixinBase):
    ...
    def unregister_listener(self: "Kushian", listener: Listener) -> None:
    ...
    def register_listeners(self: "Kushina", plug: plugin.Plugin) -> None:
    ...
    def unregister_listeners(self: "Kushina", plug: plugin.Plugin) -> None:
    ...
    async def log_stat(self: "Kushina", stat: str, *, value: int = 1) -> None:
